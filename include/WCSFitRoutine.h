...
public:
    ...
    WCSFit(Fields &fields_, vector<shared_ptr<Instrument>> instruments_, ExposuresHelper exposures_,
           ...
           vector<LONGLONG> objects, double sysErr = 2.0, double refSysErr = 2.0, int minMatches = 2,
           string skipObjectsFile = "", string fixMaps = "", bool usePM = true, int verbose = 0);
    ...
    void setObjects(int i, map<string, vector<double>> tableMap, string xKey, string yKey,
                    vector<string> xyErrKeys, string idKey = "", string pmCovKey = "", string magKey = "",
                    int magKeyElement = 0, string magErrKey = "", int magErrKeyElement = 0,
