...
void PhotoAlign::operator()(const DVector &p, double &chisq,
...
int PhotoAlign::sigmaClip(double sigThresh, bool doReserved, bool clipEntireMatch,
                          bool logging)
{
  int nclip = 0;
...
void PhotoAlign::count(long int &mcount, long int &dcount,
