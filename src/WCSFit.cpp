...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    vector<unique_ptr<Exposure>> exposures = readExposures(wcsfit.instruments,
                                                           wcsfit.fields.epochs(),
    ...
    wcsfit.extensions = readExtensions<Astro>(extensionTable,
                                              wcsfit.instruments,
                                              wcsfit.exposures,
                                              exposureColorPriorities,
                                              colorExtensions,
    ...
    if (verbose >= 0)
      cout << "# Total match count: " << wcsfit.matches.size() << endl;
